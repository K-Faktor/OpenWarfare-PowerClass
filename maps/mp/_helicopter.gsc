...
spawnchopperFx()
{
	self endon ( "death" );
        ...
        wait 0.07;
        playfxontag( level.fx_heli_red_blink, self, "tag_light_R_wing" );
    	wait 0.07;
        playfxontag( level.fx_heli_white_blink, self, "tag_light_belly" );
        wait 0.01;
        playfxontag( level.fx_heli_white_blink, self, "tag_light_tail" );
}
